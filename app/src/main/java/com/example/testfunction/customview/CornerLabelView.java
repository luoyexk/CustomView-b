...
public class CornerLabelView extends View {
    ...
    private final int RightTop = 0;
    private final int RightBottom = 1;
    private final int LeftBottom = 2;
    private final int LeftTop = 3;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (marginLeanSide >= 0) {
            if (position == RightBottom || position == LeftBottom) {
